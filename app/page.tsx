...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gunmetal via-paynes-gray to-cadet-gray">
      ...
      {/* Hero Section */}
      <section className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-64px)] text-center px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-extrabold text-jasmine mb-6 animate-float">
            Crafting <span className="text-gradient"> Moments </span>, One Meal at a Time.
          </h1>
          <p className="text-xl md:text-2xl text-cadet-gray max-w-3xl mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/menu">
              <Button
                size="lg"
                className="bg-gradient-to-r from-jasmine to-orange-pantone text-gunmetal hover:from-jasmine/90 hover:to-orange-pantone/90 text-lg px-8 py-4 font-semibold"
              >
                Explore Menus
            ...
            <Link href="/about">
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-8 py-4 border-cadet-gray/40 text-jasmine hover:bg-cadet-gray/10"
              >
                Learn More
              </Button>
            </Link>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-4xl font-bold text-jasmine text-center mb-12">
          ...
          {features.map((feature, index) => (
            ...
            >
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-jasmine mb-4">{feature.title}</h3>
                <p className="text-cadet-gray">{feature.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <Card key={index} className="glass border-cadet-gray/20">
              <CardContent className="p-8 text-center">
                <div className="bg-jasmine/20 text-jasmine rounded-full w-16 h-16 flex items-center justify-center mx-auto text-3xl font-bold mb-6">
                  {step.number}
                </div>
                <h3 className="text-xl font-semibold text-jasmine mb-4">{step.title}</h3>
                <p className="text-cadet-gray">{step.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        <Card className="glass border-cadet-gray/20">
          <CardContent className="p-12">
            <h2 className="text-4xl font-bold text-jasmine mb-6">Ready to Plan Your Next Event?</h2>
            ...
            <Link href="/auth">
              <Button
                size="lg"
                className="bg-gradient-to-r from-jasmine to-orange-pantone text-gunmetal hover:from-jasmine/90 hover:to-orange-pantone/90 text-lg px-10 py-5 font-semibold"
              >
                Get Started Today
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
